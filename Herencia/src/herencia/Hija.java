...
public class Hija extends Madre {
    ...
    public void Presentar(){ //Sobrescritura 1
        System.out.println("Soy " + getNombre());
    } //Sobrescritura 1 porque existe un método con el mismo nombre y sin parámetros

    public void AnimalFavorito(){ //Sobrescritura 2 porque existe un método con el mismo nombre y sin parámetros
